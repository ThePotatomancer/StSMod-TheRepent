...
import theRepent.characters.TheDefault;
import theRepent.events.IdentityCrisisEvent;
import theRepent.potions.PlaceholderPotion;
import theRepent.relics.BottledPlaceholderRelic;
...
public class DefaultMod implements
    ...
    private static final String AUTHOR = "Potatomancer"; // And pretty soon - You!
    ...
    public DefaultMod() {
        ...
        try {
            SpireConfig config = new SpireConfig("theRepent", "theRepentConfig", theDefaultDefaultSettings); // ...right here
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableNormalsButton = new ModLabeledToggleButton("This is the text which goes next to the checkbox.",
            ...
            try {
                ...
                SpireConfig config = new SpireConfig("theRepent", "theRepentConfig", theDefaultDefaultSettings);
