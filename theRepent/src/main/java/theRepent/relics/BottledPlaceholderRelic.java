...
import theRepent.patches.relics.BottledPlaceholderField;
import theRepent.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theRepent.DefaultMod.makeRelicOutlinePath;
import static theRepent.DefaultMod.makeRelicPath;
